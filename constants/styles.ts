...
const ColorsWithAliases = {
	...Colors,
	/** Theme-agnostic alias for brand color (same in light/dark). */
	brandPrimary: Colors.light.brand,
	/** Theme-agnostic alias for dark border/surface. */
	surfaceDark: Colors.dark.border,
	/** Theme-agnostic alias for muted text. */
...
export { DefaultSharedComponents, DefaultTypography, DefaultStyles };
export { ColorsWithAliases as Colors };
