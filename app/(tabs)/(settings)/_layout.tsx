...
export default function SettingsLayout() {
	...
	return (
		<Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: bg } }}>
			...
			<Stack.Screen
				name='account'
				options={{ headerShown: true, title: 'Account & Server', header: () => <InternalHeader /> }}
			/>
			<Stack.Screen
				name='appearance'
				options={{ headerShown: true, title: 'Appearance', header: () => <InternalHeader /> }}
			/>
			<Stack.Screen
				name='developer'
				options={{ headerShown: true, title: 'Developer', header: () => <InternalHeader /> }}
			/>
		</Stack>
	);
}
